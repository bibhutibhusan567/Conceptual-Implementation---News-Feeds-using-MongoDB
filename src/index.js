...
app.get('/newFeeds', async (req, res) => {
    // const offset = isNullOrUndefinedOrNan(req.query.offset) ? Number(req.query.offset) : 0;
    // const limit = isNullOrUndefinedOrNan(req.query.limit) ? Number(req.query.limit) : 10;
